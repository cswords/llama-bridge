...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Qwen 2.5 3B** | 3B | Q4_K_M | ~4.0s | ~11.3s | ~1.4s |
| **Qwen3-Coder-30B** | 30B | Q5_K_M | ~13.1s | ~26.6s | ~6.9s |
| **MiMo-V2-Flash** | ~70B | UD-Q6_XL | ~142.7s | ~80.7s | ~10.5s |
| **MiniMax-M2.1** | ~456B | Q8_0 | ~138.7s | ~62.7s | ~8.7s |
| **GLM-4.7-REAP** | ~218B | Q2_K | ~42.3s | ~156.2s | ~27.5s |
...
> - **Hot**: 代表缓存就绪后的后续请求。
> - *DeepSeek-V3.2 (MXFP4) 由于 llama.cpp 暂不支持其架构，暂未包含在内。*
