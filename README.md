...
| 模型配置 | 规模 | 启动耗时 | 首个请求 (Cold) | 后续请求 (Hot) |
| :--- | :--- | :--- | :--- | :--- |
| **Qwen 2.5 3B** | 3B | ~3s | 0.12s | 0.08s |
| **Qwen 30B Coder** | 30B | ~12s | 0.19s | 0.14s |
| **MiMo V2 (Sonnet)** | ~70B | ~17s | 0.67s | 0.29s |
| **GLM-4 (REAP)** | 218B | ~30s | 0.80s | 0.54s |
